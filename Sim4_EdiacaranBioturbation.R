...
#Simulation: Ediacaran biomixing and bioirrigation
...
biomixing <- 0.1 #biodiffusion coefficient (cm2 yr-1)
bioirrigation <- 3.65 #bioirrigation coefficient (yr-1)
...
#save results w
save(results.df, file="Sim4_EdiacaranBioturbation.RData")
#write_xlsx(results.df, "Output_Sim4_EdiacaranBioturbation.xlsx")