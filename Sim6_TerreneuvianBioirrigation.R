...
#Simulation: Terreneuvian bioirrigation, no biomixing
...
biomixing <- 0 #biodiffusion coefficient (cm2 yr-1)
bioirrigation <- 35.77 #bioirrigation coefficient (yr-1)
...
#save results w
save(results.df, file="Sim6_TerreneuvianBioirrigation.RData")
#write_xlsx(results.df, "Output_Sim6_TerreneuvianBioirrigatio.xlsx")