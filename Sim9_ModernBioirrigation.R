...
#Simulation: Modern bioirrigation, no biomixing
...
#save results w
save(results.df, file="Sim9_ModernBioirrigation.RData")
#write_xlsx(results.df, "Output_Sim9_ModernBioirrigation.xlsx")