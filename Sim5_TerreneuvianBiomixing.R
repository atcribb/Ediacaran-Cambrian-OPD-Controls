...
#Simulation: Terreneuvian biomixing, no bioirrigation
...
biomixing <- 0.98 #biodiffusion coefficient (cm2 yr-1)
bioirrigation <- 0 #bioirrigation coefficient (yr-1)
...
#save results w
save(results.df, file="Sim5_TerreneuvianBiomixing.RData")
#write_xlsx(results.df, "Output_Sim5_TerreneuvianBiomixing.xls")