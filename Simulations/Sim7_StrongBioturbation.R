...
#Simulation: Strong biomixing + strong bioirrigation
...
biomixing <- 10.0 #biodiffusion coefficient (cm2 yr-1)
bioirrigation <- 365 #bioirrigation coefficient (yr-1)
...
#save results 
save(results.df, file="Sim7_StrongBioturbation.RData")
write_xlsx(results.df, "Output_Sim7_StrongBioturbation.xlsx")
print('FINISHED SIMULATION 7')
