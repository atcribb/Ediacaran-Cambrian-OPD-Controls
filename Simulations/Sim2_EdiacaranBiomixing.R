...
#Simulation: Ediacaran biomixing, no bioirrigation
...
#save results w
save(results.df, file="Sim2_EdiacaranBiomixing.RData")
#write_xlsx(results.df, "Output_Sim2_EdiacaranBiomixing.xlsx")
