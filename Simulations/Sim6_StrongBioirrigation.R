...
#Simulation: Strong bioirrigation
...
#save results 
save(results.df, file="Sim6_StrongBioirrigation.RData")
write_xlsx(results.df, "Output_Sim6_StrongBioirrigation.xlsx")
print('FINISHED SIMULATION 6')
