...
#Simulation: Modern biomixing, no bioirrigation
...
biomixing <- 10 #biodiffusion coefficient (cm2 yr-1)
...
#save results w
save(results.df, file="Sim8_ModernBiomixing.RData")
#write_xlsx(results.df, "Output_Sim8_ModernBiomixing.xlsx")
