...
#save results 
save(results.df, file="Sim5_StrongBiomixing.RData")
write_xlsx(results.df, "Output_Sim5_StrongBiomixing.xlsx")
print('FINISHED SIMULATION 5')
