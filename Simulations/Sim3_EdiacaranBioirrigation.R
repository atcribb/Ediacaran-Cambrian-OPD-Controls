...
#Simulation: Ediacaran bioirrigation, no biomixing
...
#save results w
save(results.df, file="Sim3_EdiacaranBioirrigation.RData")
#write_xlsx(results.df, "Output_Sim3_EdiacaranBioirrigation.xlsx")
